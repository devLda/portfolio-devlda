            ...
            className={`
              relative flex items-center justify-center lg:w-20 xl:w-24 h-10 xl:text-xl z-0 border-2 border-blue-400 border-solid font-semibold ease-out duration-500 ${
                pathName.includes(item.path)
                  ? "bg-amber-50 text-yellow-500 dark:text-blue-400 before:w-0 after:h-0 before:bg-amber-300 before:dark:bg-black before:dark:opacity-90 after:bg-amber-300"
                  : "text-white hover:bg-amber-50 hover:text-yellow-500 dark:hover:text-blue-400 before:w-2/3 hover:before:w-0 before:bg-amber-300 before:dark:bg-black  before:hover:bg-amber-50 after:h-2/3 after:hover:h-0 after:bg-amber-300 after:dark:bg-black after:hover:bg-amber-50"
              } 
