...
const Slider = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full">
      ...
      <button
        className="absolute top-1/2 left-0 py-2 px-2 sm:px-4 text-4xl bg-blue-400 dark:bg-green-500 text-white z-10 opacity-40 hover:opacity-100"
        onClick={() => handleChange(-1)}
      >
        <FaAngleLeft />
      </button>
      <button
        className="absolute top-1/2 right-0 py-2 px-2 sm:px-4 text-4xl bg-blue-400 dark:bg-green-500 text-white z-10 opacity-40 hover:opacity-100"
        onClick={() => handleChange(1)}
      >
        <FaAngleRight />
      </button>
